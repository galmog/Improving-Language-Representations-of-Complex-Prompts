...
#
#         token = get_clip_token_for_string(embedder.tokenizer, new_placeholder) if is_sd else get_bert_token_for_string(
#             embedder.tknz_fn, new_placeholder)
#
...
#
#
sys.path.append('/path/to/external/module/directory')
